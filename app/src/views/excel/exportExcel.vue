<template>
  <div class="app-container">
    ...
    <el-button style='margin:0 0 20px 20px;' type="primary" icon="document" @click="handleDownload" :loading="downloadLoading">excel</el-button>
    ...
    <el-table :data="list" v-loading="listLoading" element-loading-text="拼命加载中" border fit highlight-current-row>
      ...
      <el-table-column label="Date" width="220" align="center" prop="display_time"/>
